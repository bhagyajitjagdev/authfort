...
def upgrade() -> None:
    ...
    sa.Column('kid', sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False),
    ...
    sa.Column('algorithm', sqlmodel.sql.sqltypes.AutoString(length=10), nullable=False),
    ...
    sa.Column('provider_account_id', sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True),
